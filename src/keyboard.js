...
(function() {
    ...
    this.VKI_kts = this.VKI_kt = "Greek Pad";  // Default keyboard layout
    ...
    VKI_attach = function(elem) {
        ...
        if (self.VKI_imageURI) {
            ...
            keybut.onclick = function(e) {
                ...
                setTimeout(function(){
                    $('#keyboardInputMaster').show();
                }, 100);
            };
            $('#keyboardButton').html(keybut);
        } else {
            ...
            keybut.onclick = function(e) {
                e = e || event;
                if (e.stopPropagation) { e.stopPropagation(); } else e.cancelBubble = true;
                // gaEventCall('send', 'event', 'Greek Kbd Link', 'User Greek Kbd Click', "click!");
                self.VKI_show(this.elem);
                setTimeout(function(){
                    $('#keyboardInputMaster').show();
                }, 100);
            ...
            elem.onfocus = function() {
                if (self.VKI_target != this) {
                    if (self.VKI_target) self.VKI_close(this);
//                  self.VKI_show(this);
                }
            };
...
//                    self.VKI_show(this);
    ...
    this.VKI_buildKeyboardInputs = function() {
        var inputElems = [
    ...
    if ((kbSelect.langCount > 1) && (VKI_languageSelect)) th.appendChild(kbSelect);
    ...
    this.VKI_show = function(elem) {
        if (!this.VKI_target) {
            ...
            this.VKI_target.focus();
            this.VKI_isOpen = true;
            $("#key-up-down").attr("src", "/assets/less.png");
        } else this.VKI_close();
    };
...
//              self.VKI_keyboard.style.left = Math.max(10, Math.min(wDim[0] - self.VKI_keyboard.offsetWidth - 25, iPos[0])) + "px";
    ...
    this.VKI_close = VKI_close = function() {
        if (this.VKI_target) {
            ...
            this.VKI_isOpen = false;
            $("#key-up-down").attr("src", "/assets/more.png");
        }
    };
